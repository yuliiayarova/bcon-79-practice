...
Пустий список (`<ul id="task-list"></ul>`) для виведення завдань.
...
app.js — для ініціалізації застосунку і основної логіки.

Папка scripts — де будуть зберігатись всі JS-файли:
